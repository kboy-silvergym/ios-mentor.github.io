...
この利用規約（以下，「本規約」といいます。）は，藤川慶（以下，「当社」といいます。）が「KBOY iOSメンター」（以下，「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下，「ユーザー」といいます。）には，本規約に従って，本サービスをご利用いただきます。
...
1. ユーザーは，本サービスの有料部分の対価として，本ウェブサイトに表示する利用料金を，PayPalの定期決済機能により支払うものとします。
2. ユーザーが利用料金の支払を遅滞した場合、特別な事情がない場合は、当社から強制的に退会の措置をとる事ができるものとする。
...
ユーザーは，Paypalの定期決済を止めることにより，本サービスから退会できるものとします。
